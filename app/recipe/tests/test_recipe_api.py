...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tag(self):
        ...
        r2 = create_recipe(user=self.user, title='Tagine de pollo')
        tag1 = Tag.objects.create(user=self.user, name='Vegan')
        tag2 = Tag.objects.create(user=self.user, name='Veggie')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user = self.user, title='Gazpacho')
    ...
    def test_filter_by_ingredient(self):
        ...
        r1 = create_recipe(user=self.user, title='Gazpacho')
        r2 = create_recipe(user=self.user, title='Salmorejo')
        ingredient1 = Ingredient.objects.create(user=self.user, name='Tomate')
        ingredient2 = Ingredient.objects.create(user=self.user, name='Pepino')
        r1.ingredients.add(ingredient1)
        r2.ingredients.add(ingredient2)
        r3 = create_recipe(user=self.user, title='Pan')
